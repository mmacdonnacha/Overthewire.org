...
Visit the url `http://natas6.natas.labs.overthewire.org` in the browser and we get a prompt for login.
...
![natas6 home page](img/natas06_home.png)


Entering the incorrect secret gives us a `wrong secret` message.

![natas6 wrong secret](img/natas06_wrong_secret.png)
...
![natas6 password](img/natas06_password.png)
