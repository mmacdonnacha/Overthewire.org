...
## Walkthrough 
Login to the server using the password obtained from the previous level [Leviathan level 3](../leviathan3/README.md). 
...
The 1's and 0's are binary representation of text.  
