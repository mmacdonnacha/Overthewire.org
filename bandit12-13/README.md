...
Solution for the Overthewire Bandit Level 12 -> 13.  
Link to overthewire [Bandit Level 12 -> 13](https://overthewire.org/wargames/bandit/bandit13.html)
...
Login to the server using the password obtained from the previous level [Bandit level 11 -> 12](../bandit11-12/README.md). 
